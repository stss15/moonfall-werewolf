...
export const PHASE_META = {
  ...
  'setup-lovers': ['The lovers wake', 'Recognise one another, but never reveal your roles.'],
...
export const STORY_CUES = {
  ...
  'setup-lovers': 'The lovers wake, recognise one another, and fall back into blissful sleep.',
